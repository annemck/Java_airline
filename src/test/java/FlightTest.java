...
public class FlightTest {
    ...
    @Test
    public void canReturnPassengersList() {
        flight.bookPassenger(passenger);
        Passenger actual = flight.getPassengers().get(0);
    ...
    @Test
    public void seatArrayListIsPopulated() {
        assertEquals(2, flight.getTotalNumberOfSeats());
    }
}
